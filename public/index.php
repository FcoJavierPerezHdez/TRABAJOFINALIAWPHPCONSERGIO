<?php
// public/index.php
// Punto de partida principal. Por ahora solo mostraremos una bienvenida y prueba de la bbdd.
...
// Esto lo borraremos más adelante, es solo para realizar el primer commit
try {
